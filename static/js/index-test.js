    ...
    render: function () {
        ...
        var PicNavNode = this.props.items.map(function (m) {
            ...
            if (m.nav_name == "Tumblr(大尺度)") {
                ...
                if (rightNow.getHours() >= 20 || rightNow.getHours() < 9) {
...
var data = [
    ...
    {href: "/channels", nav_name: "推荐频道", id: 9},
    {href: "https://github.com/liutaihua/hot-samer", nav_name: "About", id: 10},
    {href: "/tumblr", nav_name: "Tumblr(大尺度)", id: 11},
];
